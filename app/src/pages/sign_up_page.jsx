    ...
    <div className="content-container">
      <div className="signup-container">
        <form className="signup-form">
          ...
          <FormBlock label="Password" id="password-entry" type="text" min={3} max={12} isRequired={true} placeholder="Ex. MyPassword123"/>
...
export function FormBlock(props) {
    return(
        <div className="form-block">
            ...
            <input id={props.id} type="text" min={props.min} max={props.max} required={props.isRequired} placeholder={props.placeholder}></input>
        </div>
    );
}
