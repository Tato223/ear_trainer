...
import {
  C_Major_Scale, G_Major_Scale, D_Major_Scale, A_Major_Scale, B_Major_Scale, 
  Bb_Major_Scale, Db_Major_Scale, E_Major_Scale, Eb_Major_Scale, FSharp_Major_Scale,
  F_Major_Scale, Ab_Major_Scale
} from "../../types";
...
export const noteLibrary: NoteLibraryEntry[] = [
  ...
  },
  {
    ...
    culturalReferences: ["Standard tuning open string (both low E and high E) on guitar"],
  },
  {
    kind: "note",
    note: "F",
  ...
  },
  {
    ...
    culturalReferences: ["Standard orchestral tuning pitch (concert pitch, ISO 16)"],
  },
  {
    kind: "note",
    note: "B",
